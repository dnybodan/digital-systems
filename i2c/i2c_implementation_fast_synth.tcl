...
# Perform synthesis
synth_design -top i2c_top -part xc7a100tcsg324-1 -generic {CLK_FREQ=200000000}
...
# Generate reports
report_timing_summary -max_paths 10 -report_unconstrained -file i2c_top_fast_timing_summary_routed.rpt -warn_on_violation
report_utilization -file i2c_top_fast_utilization_impl.rpt
report_drc -file i2c_top_fast_drc_routed.rpt
