...
#
# AXI_DMA_Transfer_With_Bus_Sniffer_HW.tcl: Tcl script for re-creating project 'mig_from_scratch'
#
# Generated by Vivado on Thu Dec 14 13:07:15 MST 2023
...
#
# 1. This project restoration tcl script (AXI_DMA_Transfer_With_Bus_Sniffer_HW.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/dnybo/vivado_proj/mig_from_scratch/mig_from_scratch/mig_from_scratch.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/home/dnybo/Downloads/4x2_PL_DDR4.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../../../vivado_proj/mig_from_scratch/mig_from_scratch/mig_from_scratch.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/../../../Downloads/4x2_PL_DDR4.xdc"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../../../vivado_proj/ip_repo"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "mig_from_scratch"
...
set script_file "AXI_DMA_Transfer_With_Bus_Sniffer_HW.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../../vivado_proj/mig_from_scratch/mig_from_scratch"]"
...
set_msg_config  -id {[BD 41-1306]}  -suppress  -ruleid {12}  -source 2
set_msg_config  -id {[BD 41-1271]}  -suppress  -ruleid {13}  -source 2
set_msg_config  -id {[BD 41-1306]}  -suppress  -ruleid {14}  -source 2
set_msg_config  -id {[BD 41-1271]}  -suppress  -ruleid {15}  -source 2
...
set_property -name "top" -value "design_3_mig_throughput_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/../../../Downloads/4x2_PL_DDR4.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../../../Downloads/4x2_PL_DDR4.xdc"
...
# Proc to create BD design_3_mig_throughput
proc cr_bd_design_3_mig_throughput { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name design_3_mig_throughput
  ...
  user.org:user:axi_dma_sniffer:1.0\
  "
  ...
  set_property -dict [list \
    ...
    CONFIG.C0.DDR4_InputClockPeriod {4997} \
...
\
  ...
  # Create instance: axi_dma_sniffer_0, and set properties
  set axi_dma_sniffer_0 [ create_bd_cell -type ip -vlnv user.org:user:axi_dma_sniffer:1.0 axi_dma_sniffer_0 ]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M01_AXI [get_bd_intf_pins smartconnect_0/M01_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HPC0_FPD]
  connect_bd_intf_net -intf_net smartconnect_1_M00_AXI [get_bd_intf_pins smartconnect_1/M00_AXI] [get_bd_intf_pins axi_gpio_0/S_AXI]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD] [get_bd_intf_pins smartconnect_2/S00_AXI]
  ...
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tdata [get_bd_pins axi_dma_0/m_axis_mm2s_tdata] [get_bd_pins axis_data_fifo_0/s_axis_tdata] [get_bd_pins axi_dma_sniffer_0/data]
  connect_bd_net -net axi_dma_0_m_axis_mm2s_tvalid [get_bd_pins axi_dma_0/m_axis_mm2s_tvalid] [get_bd_pins axis_data_fifo_0/s_axis_tvalid] [get_bd_pins axi_dma_sniffer_0/valid]
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins axi_dma_0/mm2s_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net axi_dma_sniffer_0_bitrate_output [get_bd_pins axi_dma_sniffer_0/bitrate_output] [get_bd_pins axi_gpio_0/gpio_io_i]
  ...
  connect_bd_net -net ddr4_0_c0_init_calib_complete [get_bd_pins ddr4_0/c0_init_calib_complete] [get_bd_ports c0_init_calib_complete]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins reset_inv_0/Op1]
  connect_bd_net -net reset_inv_0_Res [get_bd_pins reset_inv_0/Res] [get_bd_pins ddr4_0/sys_rst]
  connect_bd_net -net rst_ddr4_0_300M_peripheral_aresetn [get_bd_pins rst_ddr4_0_300M/peripheral_aresetn] [get_bd_pins ddr4_0/c0_ddr4_aresetn] [get_bd_pins smartconnect_2/aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins smartconnect_1/aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_dma_sniffer_0/reset]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_0/dout] [get_bd_pins axi_dma_sniffer_0/ready]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins ddr4_0/c0_ddr4_ui_clk] [get_bd_pins smartconnect_2/aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins rst_ddr4_0_300M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins smartconnect_1/aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_dma_sniffer_0/clk]

  # Create address segments
  assign_bd_address -offset 0x80000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
  ...
  assign_bd_address -offset 0x80000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_TopLeft":"1490,182",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.5.8 2022-09-21 7111 VDI=41 GEI=38 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port c0_ddr4 -pg 1 -lvl 7 -x 2500 -y 550 -defaultsOSRD
preplace port diff_clock_rtl -pg 1 -lvl 0 -x -20 -y 570 -defaultsOSRD
preplace port port-id_c0_init_calib_complete -pg 1 -lvl 7 -x 2500 -y 570 -defaultsOSRD
preplace port port-id_reset -pg 1 -lvl 0 -x -20 -y 830 -defaultsOSRD
preplace inst axi_dma_0 -pg 1 -lvl 4 -x 1510 -y 170 -defaultsOSRD
preplace inst axis_data_fifo_0 -pg 1 -lvl 3 -x 1100 -y 140 -defaultsOSRD
preplace inst ddr4_0 -pg 1 -lvl 6 -x 2290 -y 600 -defaultsOSRD
preplace inst reset_inv_0 -pg 1 -lvl 5 -x 1920 -y 830 -defaultsOSRD
preplace inst rst_ddr4_0_300M -pg 1 -lvl 2 -x 540 -y 670 -defaultsOSRD
preplace inst smartconnect_0 -pg 1 -lvl 5 -x 1920 -y 120 -defaultsOSRD
preplace inst smartconnect_2 -pg 1 -lvl 3 -x 1100 -y 330 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 1 -x 120 -y 460 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 2 -x 540 -y 420 -defaultsOSRD
preplace inst smartconnect_1 -pg 1 -lvl 3 -x 1100 -y 550 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 4 -x 1510 -y 560 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 4 -x 1510 -y 430 -defaultsOSRD
preplace inst axi_dma_sniffer_0 -pg 1 -lvl 5 -x 1920 -y 420 -defaultsOSRD
preplace netloc axi_dma_0_m_axis_mm2s_tdata 1 2 3 950 420 1290 360 1750
preplace netloc axi_dma_0_m_axis_mm2s_tvalid 1 2 3 940 440 1310 370 1740
preplace netloc axi_dma_0_mm2s_introut 1 0 5 20 300 NJ 300 930J 430 1280J 350 1720
preplace netloc axi_dma_0_s2mm_introut 1 0 5 20 530 NJ 530 880J 470 1250J 640 1710
preplace netloc axi_dma_sniffer_0_bitrate_output 1 4 2 NJ 570 2070
preplace netloc ddr4_0_c0_ddr4_ui_clk_sync_rst 1 1 6 230 560 860J 650 NJ 650 1770J 560 2080J 490 2470
preplace netloc ddr4_0_c0_init_calib_complete 1 6 1 NJ 570
preplace netloc reset_1 1 0 5 NJ 830 NJ 830 NJ 830 NJ 830 NJ
preplace netloc reset_inv_0_Res 1 5 1 2110J 630n
preplace netloc rst_ddr4_0_300M_peripheral_aresetn 1 2 4 870 0 1270 320 1770 320 2090J
preplace netloc xlconcat_0_dout 1 1 1 N 460
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 1 6 220 310 900 450 1300 330 1760 300 NJ 300 2480
preplace netloc xlconstant_0_dout 1 4 1 1730 430n
preplace netloc axi_dma_0_M_AXIS_MM2S 1 2 3 950 10 NJ 10 1710
preplace netloc axi_dma_0_M_AXI_MM2S 1 4 1 N 90
preplace netloc axi_dma_0_M_AXI_S2MM 1 4 1 N 110
preplace netloc axis_data_fifo_0_M_AXIS 1 3 1 N 140
preplace netloc ddr4_0_C0_DDR4 1 6 1 NJ 550
preplace netloc diff_clock_rtl_1 1 0 6 NJ 570 NJ 570 850J 660 NJ 660 NJ 660 2100J
preplace netloc smartconnect_0_M00_AXI 1 5 1 2110 110n
preplace netloc smartconnect_0_M01_AXI 1 1 5 230 320 920J 410 1260J 310 NJ 310 2070
preplace netloc smartconnect_1_M00_AXI 1 3 1 1310 540n
preplace netloc smartconnect_2_M00_AXI 1 3 1 1250 120n
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 2 1 910 310n
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM1_FPD 1 2 1 890 430n
levelinfo -pg 1 -20 120 540 1100 1510 1920 2290 2500
pagesize -pg 1 -db -bbox -sgen -170 -10 2720 940
"
}
...
# End of cr_bd_design_3_mig_throughput()
cr_bd_design_3_mig_throughput ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files design_3_mig_throughput.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files design_3_mig_throughput.bd ] 
set_property IS_ENABLED "1" [get_files design_3_mig_throughput.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files design_3_mig_throughput.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files design_3_mig_throughput.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files design_3_mig_throughput.bd ] 
set_property PFM_NAME "" [get_files design_3_mig_throughput.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files design_3_mig_throughput.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files design_3_mig_throughput.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files design_3_mig_throughput.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files design_3_mig_throughput.bd ] 
set_property USED_IN_SIMULATION "1" [get_files design_3_mig_throughput.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files design_3_mig_throughput.bd ] 



# Proc to create BD design_2_mig_throughput
proc cr_bd_design_2_mig_throughput { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name design_2_mig_throughput
...
\
  ...
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins reset_inv_0/Op1]
  connect_bd_net -net reset_inv_0_Res [get_bd_pins reset_inv_0/Res] [get_bd_pins ddr4_0/sys_rst]
  connect_bd_net -net rst_ddr4_0_300M_peripheral_aresetn [get_bd_pins rst_ddr4_0_300M/peripheral_aresetn] [get_bd_pins ddr4_0/c0_ddr4_aresetn] [get_bd_pins smartconnect_2/aresetn] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins ddr4_0/c0_ddr4_ui_clk] [get_bd_pins smartconnect_2/aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins rst_ddr4_0_300M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk]

  # Create address segments
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x000100000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
  assign_bd_address -offset 0x000800000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_LOW] -force
  assign_bd_address -offset 0x000100000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
...
# End of cr_bd_design_2_mig_throughput()
cr_bd_design_2_mig_throughput ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files design_2_mig_throughput.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files design_2_mig_throughput.bd ] 
set_property IS_ENABLED "1" [get_files design_2_mig_throughput.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files design_2_mig_throughput.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files design_2_mig_throughput.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files design_2_mig_throughput.bd ] 
set_property PFM_NAME "" [get_files design_2_mig_throughput.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files design_2_mig_throughput.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files design_2_mig_throughput.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files design_2_mig_throughput.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files design_2_mig_throughput.bd ] 
set_property USED_IN_SIMULATION "1" [get_files design_2_mig_throughput.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files design_2_mig_throughput.bd ] 
...
\
    ...
    CONFIG.PSU__CRL_APB__PCAP_CTRL__FREQMHZ {200} \
    CONFIG.PSU__CRL_APB__PCAP_CTRL__SRCSEL {IOPLL} \
    CONFIG.PSU__CRL_APB__PL0_REF_CTRL__ACT_FREQMHZ {174.999985} \
    CONFIG.PSU__CRL_APB__QSPI_REF_CTRL__FREQMHZ {125} \
    CONFIG.PSU__CRL_APB__RPLL_CTRL__SRCSEL {PSS_REF_CLK} \
    CONFIG.PSU__CRL_APB__SDIO0_REF_CTRL__ACT_FREQMHZ {187.499969} \
    CONFIG.PSU__CRL_APB__SDIO0_REF_CTRL__FREQMHZ {200} \
...
\
  ...
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins reset_inv_0/Op1]
  connect_bd_net -net reset_inv_0_Res [get_bd_pins reset_inv_0/Res] [get_bd_pins ddr4_0/sys_rst]
  connect_bd_net -net rst_ddr4_0_300M_peripheral_aresetn [get_bd_pins rst_ddr4_0_300M/peripheral_aresetn] [get_bd_pins ddr4_0/c0_ddr4_aresetn] [get_bd_pins smartconnect_2/aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins ddr4_0/c0_ddr4_ui_clk] [get_bd_pins smartconnect_2/aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins rst_ddr4_0_300M/slowest_sync_clk]
...
if { [get_property IS_LOCKED [ get_files -norecurse design_3_mig_throughput.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../../vivado_proj/mig_from_scratch/mig_from_scratch/mig_from_scratch.gen/sources_1/bd/design_3_mig_throughput/hdl/design_3_mig_throughput_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse design_3_mig_throughput.bd] -top]
  add_files -norecurse -fileset sources_1 $wrapper_path
}

if { [get_property IS_LOCKED [ get_files -norecurse design_2_mig_throughput.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../../vivado_proj/mig_from_scratch/mig_from_scratch/mig_from_scratch.gen/sources_1/bd/design_2_mig_throughput/hdl/design_2_mig_throughput_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse design_2_mig_throughput.bd] -top]
  add_files -norecurse -fileset sources_1 $wrapper_path
}

if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../../../vivado_proj/mig_from_scratch/mig_from_scratch/mig_from_scratch.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
...
set_property -name "incremental_checkpoint" -value "$proj_dir/mig_from_scratch.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/mig_from_scratch.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/mig_from_scratch.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/mig_from_scratch.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
